# Price_Prediction_Uber
- Analyze the prices of ride-sharing apps and understand what factors are driving the demand.  
- Predict the price of a cab ride, using a neural network.  
